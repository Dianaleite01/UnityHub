...
namespace UnityHub.Migrations
{
    ...
    [Migration("20240614150444_RolesAdicionadas")]
    partial class RolesAdicionadas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnityHub.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "cf6baa45-932f-4f54-adee-7649b6caf7de",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEzsL1CWRxFQQZmSDm3Tn5ia2K+TTT0lTdUXnnnlrugjVpoWZMi4eLG2R51OR1GMuA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "200ba98e-6d32-49b2-9e9e-d2e967a99189",
            ...
            modelBuilder.Entity("UnityHub.Models.Voluntariados", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UnityHub.Models.Candidaturas", b =>
                {
                    ...
                    b.HasOne("UnityHub.Models.Voluntariados", "Voluntariado")
                        .WithMany("ListaCandidaturas")
                        .HasForeignKey("VoluntariadoFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UnityHub.Models.Utilizadores", b =>
                {
                    ...
                    b.Navigation("ListaVoluntariados");
                });
